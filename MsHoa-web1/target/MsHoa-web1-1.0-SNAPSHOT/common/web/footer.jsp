...
<footer class="footer_area">
    <div class="footer_widgets_area">
            ...
            <div class="f_widgets_inner row">
                ...
                <div class="col-lg-3 col-md-6">
                    <aside class="f_widget contact_widget">
                        ...
                        <a href="#">01642950417</a>
                        <a href="#">trinhngoclinh0308@gmail.com</a>
        ...
        <div class="copy_right_area">
            <div class="container">
                <div>
                    <h5>Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">LnH</a></h5>
                </div>
            </div>
        </div>
    </div>
