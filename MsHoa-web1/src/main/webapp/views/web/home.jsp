    ...
    <div id="main_slider" class="rev_slider" data-version="5.3.1.6">
        <ul>
            <li data-index="rs-2946" data-transition="slidevertical" data-slotamount="1" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                <!-- MAIN IMAGE -->
                <img src="../template/web/img/home-slider/slider-1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                <!-- LAYER NR. 1 -->
                <div class="slider_text_box">
                    <%--<div class="tp-caption tp-resizeme rev-btn first_text"--%>
                         ...
                         <%--style="z-index: 8;font-family: 'Poppins', sans-serif;font-weight:600;color:#fff;text-transform: uppercase;"><img src="../template/web/img/play-video.png" alt=""> <span style="text-decoration: underline;padding-left: 10px;">Watch The Overview</span></div>--%>
                    ...
                    <div class="tp-caption tp-resizeme secand_text"
                         ...
                         style="z-index: 8;font-family:'Poppins', sans-serif;font-weight:700;color:#fff;">Hãy tham gia lớp học Toeic của chúng tôi<br />Vì nó miễn phí!
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme slider_button"
                         ...
                         data-frames="[{&quot;delay&quot;:10,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;0&quot;,&quot;from&quot;:&quot;y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;&quot;,&quot;mask&quot;:&quot;x:0px;y:[100%];s:inherit;e:inherit;&quot;,&quot;to&quot;:&quot;o:1;&quot;,&quot;ease&quot;:&quot;Power2.easeInOut&quot;},{&quot;delay&quot;:&quot;wait&quot;,&quot;speed&quot;:1500,&quot;frame&quot;:&quot;999&quot;,&quot;to&quot;:&quot;y:[175%];&quot;,&quot;mask&quot;:&quot;x:inherit;y:inherit;s:inherit;e:inherit;&quot;,&quot;ease&quot;:&quot;Power2.easeInOut&quot;}]"
                         data-textAlign="['center','center','center','center','center','center']">
                        <a  href="#"><button type="button" class="btn btn-info">Về chứng tôi</button></a>
                        <a  href="#"><button type="button" class="btn btn-info">Đăng kí</button></a>
                    </div>
                </div>
            </li>
            <li data-index="rs-2947" data-transition="slidevertical" data-slotamount="1" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                <!-- MAIN IMAGE -->
                <img src="../template/web/img/abc.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                <!-- LAYER NR. 1 -->
                <div class="slider_text_box">
                    <div class="tp-caption tp-resizeme secand_text"
                         data-x="['center','center','center','center','center','center']"
                         ...
                         style="z-index: 8;font-family:'Poppins', sans-serif;font-weight:700;color:#fff;">Đến với MsHoa Toeic<br />Học, thi thử Toeic như thi thật!
                    </div>
...
<section class="creative_feature_area " style="margin-top: 20px">
    <div class="container">
        <div class="c_feature_box">
            <!-- <div class="row"> -->
            <div class="l_news_inner">
                <div class="row">
                    <div class="col-lg-4 col-md-6 slideInRight"  data-wow-duration="5s" data-wow-delay="0" data-wow-iteration="1000">
                        <div class="l_news_item slideInRight">
                            <div class="l_news_img"><a href="#"><img class="img-fluid" src="../template/web/img/blog/l-news/l-news-1.jpg" alt=""></a></div>
                            <div class="l_news_content slideInRight">
                                <a href="#"><h4>Hướng dẫn phần nghe</h4></a>
                    ...
                    <div class="col-lg-4 col-md-6 slideInRight">
                        <div class="l_news_item">
                            <div class="l_news_img"><a href="#"><img class="img-fluid" src="../template/web/img/blog/l-news/l-news-2.jpg" alt=""></a></div>
                            <div class="l_news_content">
                                <a href="#"><h4>Làm bài tập</h4></a>
                                <p>The Fancy that recognize the talent and effort of the best web designers, develop-ers and agencies in the world.</p>
                                <a class="more_btn" href="#">Learn More</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 slideInRight">
                        <div class="l_news_item">
                            <div class="l_news_img"><a href="#"><img class="img-fluid" src="../template/web/img/blog/l-news/l-news-3.jpg" alt=""></a></div>
                            <div class="l_news_content">
                                <a href="#"><h4>Thi thử Toeic</h4></a>
                                <p>The Fancy that recognize the talent and effort of the best web designers, develop-ers and agencies in the world.</p>
                                <a class="more_btn" href="#">Learn More</a>
                            </div>
                        </div>
        ...
        <div class="c_feature_box" style="margin-top: 55px">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="d_feature_img">
                        <img src="../template/web/img/feature-right.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<section class="service_area">
    <div class="container">
        <div class="center_title">
            <h2>Our Services</h2>
            <p>Chúng tôi đang phát triển thêm để cung cấp thêm ngôn ngữ tiếng nhật cho các bạn</p>
        </div>
        <div class="row service_item_inner">
            ...
            <div class="col-lg-4">
                <div class="service_item">
                    ...
                    <h4>Sắp ra mắt tính năng học tiếng nhật</h4>
                    <p>The Fancy that recognize the talent and effort of the best web designers, developers and agencies in the world.</p>
                </div>
            </div>
        </div>
